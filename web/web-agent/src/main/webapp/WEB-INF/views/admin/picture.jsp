		...
		<div class="page-title mod_header">
			<div class="title-env col-sm-12">
	            ...
	            <div class="input-text input-btn" style="margin-left: 30px;float: left;min-width: 100px;">
	            	<button class="btn btn-info btn-block" onclick="add()"style="height: 34px;"><span class="fa-plus"></span>  添加图文</button>
	            </div>
				...
				"columns": [
					...
					{ "data": "img",
						"render": function (a, b, c, d) {
							if(c.img){
							    var html = "<img height='60px' width='60px' src='" + c.img + "'>";
							    return html;
							} else {
								return "";
							}
