		...
		<div class="page-title mod_header">
			<div class="title-env col-sm-12">
	            ...
	            <div class="input-text input-btn" style="margin-left: 30px;float: left;min-width: 100px;">
	            	<button class="btn btn-info btn-block" onclick="add()"style="height: 34px;"><span class="fa-plus"></span>  添加老师</button>
	            </div>
	                    ...
	                    <div class="row">
							<div class="col-xs-12">
								...
								<div class="col-xs-10 form-group">
									...
									<!-- 加载编辑器的容器 -->
									<script id="a_title" name="a_title" type="text/plain" style="width: 95%;height: 200px;"></script>
									<script>
	...
	<script type="text/javascript">
		...
		function showTable(){
			...
			var dataConfig = {
				...
				"columns": [
					{ "data": "pageOrder","width":"50px"/* ,"visible": false */},
					{ "data": "img",
						"render": function (a, b, c, d) {
							if(c.img){
							    var html = "<img height='60px' src='" + c.img + "'>";
							    return html;
							} else {
								return "";
							}
		...
		function edit(data) {
	        ...
	        if(uet.queryCommandState('source')==1){
	        	uet.execCommand( 'source');
	        }
	        uet.setContent(data.title);
