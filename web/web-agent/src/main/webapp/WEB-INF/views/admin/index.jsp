		...
		<div class="page-title mod_header">
			<div class="title-env col-sm-12">
	            ...
	            <div class="input-text input-btn" style="margin-left: 30px;float: left;min-width: 100px;">
	            	<button class="btn btn-info btn-block" onclick="add()"style="height: 34px;"><span class="fa-plus"></span>  添加菜单</button>
	            </div>
	            ...
	            <form id="editForm">
	                ...
	                <div class="modal-body">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xs-6 form-group">
	                        	<input type="text" class="form-control colorpicker" id="colour" name="colour"/>
	                        </div>
	                    </div>
	                    <div class="row">
	                        <div class="col-xs-2 form-label">
	                    ...
	                    <div class="row">
	                        <div class="col-xs-2 form-label">
	                            <label class="control-label" for="tagsinput-1">背景颜色：</label>
	                        </div>
	                        <div class="col-xs-6 form-group">
	                        	<input type="text" class="form-control colorpicker" id="content" name="content"/>
	                        </div>
	                    </div>
	                    <div class="row">
	                        <div class="col-xs-2 form-label">
